...
class Settings(BaseSettings):
    ...
    BAD_SPAN_TYPES: List[str] = [
        ...
        "Page-header",
        "Picture",
    ]  # You can add "Caption" and "Footnote" here to get rid of those elements - this just removes the text, not the image in case of Picture
    ...
    HEADING_MERGE_THRESHOLD: float = 0.25
...
class ElemSettings(BaseSettings):
    ...
    TEXIFY_DPI: int = 96  # DPI to render images at
    TEXIFY_BATCH_SIZE: Optional[int] = None  # Defaults to 6 for cuda, 12 otherwise
    TEXIFY_MODEL_NAME: str = os.path.join(MODEL_DIR, "texify")
